                  ...
                  <section id="chat" className="scroll-mt-24 space-y-3">
                    ...
                    <UL
                      items={[
                        ...
                        "Users must not use chat to threaten, exploit, harass, impersonate, sexually exploit, groom, stalk, intimidate, or coordinate harm.",
                  ...
                  <section id="children" className="scroll-mt-24 space-y-3">
                    ...
                    <UL
                      items={[
                        ...
                        "Adults must not use StayKnown to exploit, groom, pressure, secretly monitor, or unlawfully control minors or vulnerable persons.",
