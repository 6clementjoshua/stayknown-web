// app/contact-approval/page.tsx
import crypto from "crypto";
import ContactApprovalClient from "./contact-approval-client";
      ...
      <div className="w-full max-w-[560px] rounded-[32px] border border-black/10 bg-white/92 shadow-[0_30px_100px_rgba(0,0,0,0.12)] backdrop-blur-2xl p-6 md:p-8">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="mt-3 text-[13px] leading-6 text-black/62">
            This contact confirmation link is no longer valid. For privacy and
          ...
          <div className="mt-5 rounded-[22px] border border-black/8 bg-black/[0.03] px-4 py-4 text-left">
            ...
            <div className="mt-2 text-[13px] leading-6 text-black/66">
              If this request was not expected, do not proceed. StayKnown is for
              known, trusted, and legitimate safety relationships only.
            </div>
          </div>
...
export default async function ContactApprovalPage({
  searchParams,
}: {
  searchParams:
