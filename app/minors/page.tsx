              ...
              <aside className="border-b border-white/10 bg-black/35 p-5 lg:sticky lg:top-0 lg:h-screen lg:border-b-0 lg:border-r lg:p-6">
                ...
                <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-white/[0.032] p-4">
                  ...
                  <p className="mt-2 text-[12px] font-semibold leading-relaxed text-white/50">
                    ...
                    pressure, threaten, shame, or control a minor.
                  </p>
                </div>
              </aside>
                ...
                <div className="space-y-8">
                  <section id="summary" className="scroll-mt-24 space-y-4">
                    ...
                    <P>
                      ...
                      harassment, coercion, hidden monitoring, and unsafe
                      contact.
                    </P>
                  ...
                  <section id="chat" className="scroll-mt-24 space-y-3">
                    ...
                    <UL
                      items={[
                        "No grooming, exploitation, coercion, threats, harassment, intimidation, impersonation, or unsafe contact.",
                  ...
                  <section id="prohibited" className="scroll-mt-24 space-y-3">
                    ...
                    <UL
                      items={[
                        ...
                        "No using StayKnown to target, exploit, threaten, intimidate, shame, or manipulate minors.",
                  ...
                  <section id="reports" className="scroll-mt-24 space-y-3">
                    ...
                    <P>
                      ...
                      used to target, exploit, threaten, harass, manipulate,
                      impersonate, or pressure a minor, report it as soon as it
                      is safe to do so.
                    </P>
                    <UL
                      items={[
                  ...
                  <section id="law" className="scroll-mt-24 space-y-3">
                    ...
                    <P>
                      ...
                      trafficking, kidnapping, credible threats, fraud, or
                      imminent harm.
                    </P>
                    <UL
                      items={[
                  ...
                  <section id="contact" className="scroll-mt-24 space-y-3">
                    ...
                    <UL
                      items={[
                        ...
                        "Use Abuse Reporting for unsafe contact, impersonation, harassment, false emergencies, or minor-related misuse.",
                  ...
                  <section className="space-y-3 rounded-[1.6rem] border border-white/10 bg-white/[0.032] p-5">
                    ...
                    <P>
                      ...
                      must never be used to target, exploit, threaten, shame,
                      secretly monitor, or control a minor. If immediate danger
                      exists, contact the official local emergency number or
                      appropriate child-safety authority first.
                    </P>
                  </section>
                </div>
