...
export default async function FooterPoliciesPage() {
  ...
  const policies = (data || []) as FooterPolicy[];

  return (
    <main className="sk-footer-policies" style={mainStyle}>
      <style>{`
        .sk-footer-policies {
          font-family:
            Inter,
        ...
        .sk-footer-policies input,
        .sk-footer-policies select,
        .sk-footer-policies textarea {
          transition:
            border-color 180ms ease,
            box-shadow 180ms ease,
            background 180ms ease;
        ...
        .sk-footer-policies input:hover,
        .sk-footer-policies select:hover,
        .sk-footer-policies textarea:hover {
          border-color: rgba(0,0,0,0.20) !important;
          box-shadow: 0 12px 34px rgba(0,0,0,0.045);
        }

        .sk-footer-policies input:focus,
        .sk-footer-policies select:focus,
        .sk-footer-policies textarea:focus {
      ...
      <section style={containerStyle}>
        <header className="sk-footer-header" style={headerStyle}>
          <div>
            <div style={kickerStyle}>StayKnown Mail Console</div>

            <h1 style={h1Style}>Footer Policies</h1>

            <p style={subStyle}>
              Edit footer text without touching code. Logged in as {adminEmail}
            </p>
          </div>
        ...
        <section style={panelStyle}>
          {policies.map((p) => (
            <form
              key={p.id}
              action="/api/mail-console/footer-policy"
              method="post"
              className="sk-policy-card"
              style={policyCardStyle}
            >
              <input type="hidden" name="id" value={p.id} />

              <div style={{ display: "grid", gap: 14 }}>
                <div className="sk-policy-grid" style={policyGridStyle}>
                  <div>
                ...
                <div>
                  <label style={labelStyle}>Footer text / policy</label>
                  <textarea
                    name="footer_html"
                    defaultValue={p.footer_html}
                    style={{
                      ...inputStyle,
                      minHeight: 130,
                      resize: "vertical",
                ...
                <div style={policyFooterRowStyle}>
...
const policyFooterRowStyle: CSSProperties = {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  gap: 12,
