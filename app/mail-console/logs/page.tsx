  ...
  return (
    <main className="sk-mail-logs" style={mainStyle}>
      <style>{`
        ...
        .sk-log-action:hover::before {
          transform: translateX(135%);
        }

        .sk-premium-button:active,
        .sk-log-action:active {
          transform: translateY(0) scale(0.975);
        }

        .sk-premium-button:active::after,
        .sk-log-action:active::after {
          opacity: 1;
...
const actionLinkStyle: CSSProperties = {
  ...
  boxShadow:
    "inset 0 1px 0 rgba(255,255,255,0.96), 0 8px 18px rgba(0,0,0,0.045)",
  whiteSpace: "nowrap",
};
