...
const nextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "img-src 'self' https://*.supabase.co https://*.storage.supabase.co data: blob: https://api.mapbox.com https://*.tiles.mapbox.com https://*.mapbox.com https://api.tomtom.com https://*.api.tomtom.com https://*.tomtom.com",
